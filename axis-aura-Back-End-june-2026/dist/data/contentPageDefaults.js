...
exports.contentPageDefaults = void 0;
exports.getContentPageDefault = getContentPageDefault;
exports.contentPageDefaults = [
    {
        slug: 'privacy-policy',
        introText: 'Your privacy matters to us. This policy explains how Axis Aura Real Estate collects, uses, and protects your personal information when you explore properties, connect with our team, or use our services.',
        hero: {
    ...
    },
    {
        ...
        introText: 'Please read these terms carefully before using Axis Aura Real Estate. They outline the rules, responsibilities, and conditions that apply when you browse listings or engage with our services.',
        hero: {
...
function getContentPageDefault(slug) {
    return exports.contentPageDefaults.find((page) => page.slug === slug);
}
