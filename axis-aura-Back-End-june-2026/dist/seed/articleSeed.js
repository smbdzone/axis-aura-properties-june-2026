...
const articles = [
    {
        ...
        seoDescription: "An overview of Dubai's record-breaking real estate performance in 2026 and the factors driving demand.",
    ...
    },
    {
        ...
        seoDescription: "How the UAE's updated Golden Visa rules benefit real estate investors and their families.",
    ...
    },
    {
        ...
        seoDescription: "What RERA's stricter escrow compliance means for off-plan buyers and developers in Dubai.",
    ...
    },
    {
        ...
        seoDescription: 'Why ultra-luxury villas on Palm Jumeirah are attracting record demand from global buyers.',
    ...
    },
    {
        ...
        seoDescription: "An overview of Business Bay's rise as a leading commercial real estate destination in Dubai.",
    ...
    },
    {
        ...
        seoDescription: 'Axis Aura introduces a curated portfolio of premium Dubai properties with exclusive buyer benefits.',
...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        for (const article of articles) {
            const result = yield article_model_1.Article.updateOne({ slug: article.slug }, { $set: article }, { upsert: true });
        ...
        console.log(`Article seed complete. Created: ${created}, Updated: ${updated}, Total: ${articles.length}.`);
