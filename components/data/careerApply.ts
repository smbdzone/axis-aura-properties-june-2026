...
export const careerApplySection = {
  ...
  requirements: {
    ...
    description:
      "Candidates must have native or professional fluency in English and a strong operational knowledge of Dubai Land Department (DLD) rules and systems; applications not meeting these criteria will not be processed.",
    ctaLabel: "Apply Now",
  },
  form: {
